...
## Project overview
- this project is an Angular application to display and manage information about Linkin Park concerts
- Language: TypeScript
- Framework: Angular
- UI: PrimeNG
...
- When making API calls, don't use HTTP requests or the generated client directly. Instead, make sure to use a suitable service class
