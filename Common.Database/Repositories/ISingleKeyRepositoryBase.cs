...
public interface ISingleKeyRepositoryBase<TDataObject, TPrimaryKey>
{
    ...
    public Task<TDataObject?> GetByPrimaryKeyAsync(TPrimaryKey primaryKey, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken"></param>
    /// <returns>Found entry or null if it was not found</returns>
    public Task<TDataObject?> GetByPrimaryKeyWithoutReferencesAsync(TPrimaryKey primaryKey, CancellationToken cancellationToken = default);
}