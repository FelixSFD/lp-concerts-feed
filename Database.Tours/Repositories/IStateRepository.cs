...
public interface IStateRepository : IRepositoryBase<StateDo>
{
    ...
    /// <summary>
    /// Returns a state by its primary key without any information about the country
    /// </summary>
    /// <param name="countryCode">ISO code of the country this state is a part of</param>
    /// <param name="stateCode">Code for this state</param>
    /// <returns></returns>
    public Task<StateDo?> GetByPrimaryKeyWithoutCountryAsync(string countryCode, string stateCode);
}